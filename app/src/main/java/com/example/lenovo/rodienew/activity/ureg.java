...
public class ureg extends AppCompatActivity {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sedname.equals("")) {
                    ...
                    if(scat=="User") {
                        url = ipaddress.ip + "uinsert.php?name=" + snamecheck + "&email=" + sedemail + "&pass=" + sedpass + "&phone=" + sedno + "&city=" + scity + "&state=" + sstate + "&country=" + scon + "&add=" + saddrcheck;
                    }
                    else {
    ...
    class inserdata extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(ureg.this, "Account Created Successsfully", Toast.LENGTH_SHORT).show();
